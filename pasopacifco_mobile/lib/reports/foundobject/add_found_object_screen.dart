...
class AddFoundObjectScreen extends StatelessWidget {
  AddFoundObjectScreen({Key? key}) : super(key: key);
  ...
  Widget _buildInputinner(BuildContext context) {
    return CustomTextFormField(
      ...
      hintText: "Comunmente encontrado",
  ...
  Widget _buildDescription(BuildContext context) {
    return CustomTextFormField(
      ...
      hintText:
          "Las corcholatas/tapas de botella de metal son tapas pequeñas, generalmente acanaladas, que se utilizan para sellar botellas y suelen desecharse tras su uso.",
      hintStyle: theme.textTheme.bodyMedium!,
