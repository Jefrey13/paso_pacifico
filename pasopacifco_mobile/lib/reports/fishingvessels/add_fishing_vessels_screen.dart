...
class AddFishingVesselsScreen extends StatelessWidget {
  AddFishingVesselsScreen({Key? key}) : super(key: key);
  ...
  Widget _buildDescription(BuildContext context) {
    return CustomTextFormField(
      ...
      hintText:
          "La cuerda es un segmento de material trenzado, generalmente de fibras sintéticas o naturales, donde cada metro se considera una pieza individual.",
      hintStyle: theme.textTheme.bodyMedium!,
