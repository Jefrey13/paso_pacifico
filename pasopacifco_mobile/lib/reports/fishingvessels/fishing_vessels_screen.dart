...
class FishingVesselsScreen extends StatelessWidget {
  FishingVesselsScreen({Key? key}) : super(key: key);
                ...
                child: Column(
                  children: [
                    ...
                    CustomElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.pushNamed(context, AppRoutes.packagingScreen);
                      },
                    )
                  ],
                ),
      ...
      child: Row(
        ...
        children: [
          Align(
            ...
            child: Text(
              "Listado de avíos pesqueros",
              style: theme.textTheme.titleMedium,
            ),
          ),
          IconButton(
            onPressed: () {
              Navigator.pushNamed(context, AppRoutes.addFishingVesselsScreen);
            },
