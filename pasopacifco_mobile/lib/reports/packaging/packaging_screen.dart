...
class PackagingScreen extends StatelessWidget {
  PackagingScreen({Key? key}) : super(key: key);
                ...
                child: Column(
                  children: [
                    ...
                    CustomElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.pushNamed(
                            context, AppRoutes.environmentScreen);
                      },
                    )
                  ],
                ),
      ...
      child: Row(
        ...
        children: [
          Align(
            ...
            child: Text(
              "Listado de materiales de empaque",
              style: theme.textTheme.titleMedium,
            ),
          ),
          IconButton(
            onPressed: () {
              Navigator.pushNamed(context, AppRoutes.addPackagingScreen);
            },
